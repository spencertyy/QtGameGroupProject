...
template <> constexpr inline auto loginPage::qt_create_metaobjectdata<qt_meta_tag_ZN9loginPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'displayUserProfile'
        QtMocHelpers::SlotData<void(UserInfo *)>(5, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'loginFailed'
...
void loginPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->displayUserProfile((*reinterpret_cast<std::add_pointer_t<UserInfo*>>(_a[1]))); break;
        case 2: _t->loginFailed(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (loginPage::*)(QString , QString )>(_a, &loginPage::loginAttempt, 0))
            return;
    }
}
...
// SIGNAL 0
void loginPage::loginAttempt(QString _t1, QString _t2)
{
